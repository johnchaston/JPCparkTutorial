...
## Figure 3
### Figure 3A
```{r Figure3A, exercise=T, warning = F, message = F, exercise.timelimit = 10000, eval = F}
	## taxon plot 
    ## specify variables
    var1 = "genotype"
    var2 = "sex"
...
### Figure 3B
Make the PCoA plots
```{r Figure3B, exercise = T, warning =F, message = F,  exercise.timelimit = 10000, eval = F}
...
### Figure 3 weighted Unifrac PERMANOVA
```{r f3wu, exercise = T, warning =F, message = F,  exercise.timelimit = 10000, eval = F}
...
flies_unifrac_table <- flies_weighted %>% dplyr::select(X) %>% left_join(read.table(url("https://raw.githubusercontent.com/johnchaston/JPCparkTutorial/master/files/call_mapper2.tsv"),comment.char = "", header=T, fill=T, sep="\t"), by=c("X"="X.SampleID")) %>% droplevels()

fig1_Sw_permanova <- adonis(flies_weighted_dm ~ genotype * sex + vial_model, flies_unifrac_table, permutations = 1000)
...
### Figure S5A
```{r FigureS5A,exercise=T, warning = F, message = F, exercise.timelimit = 10000, eval = F}
...
### Figure 3 Bray curtis PERMANOVA
```{r f3bc, exercise = T, warning =F, message = F,  exercise.timelimit = 10000, eval = F}
    ## bray curtis
...
flies_unifrac_table <- flies_bc %>% dplyr::select(X) %>% left_join(read.table(url("https://raw.githubusercontent.com/johnchaston/JPCparkTutorial/master/files/call_mapper2.tsv"),comment.char = "", header=T, fill=T, sep="\t"), by=c("X"="X.SampleID")) %>% droplevels()

fig1_Sb_permanova <- adonis(flies_bc_dm ~ genotype * sex + vial_model, flies_unifrac_table, permutations = 1000)
...
### Figure S5B
```{r FigureS5B, exercise=T, warning = F, message = F,  exercise.timelimit = 10000, eval = F}
    ## set the variables
var1 = "genotype"
var2 = "sex"
var1_colors <-c("black","black","blue","blue","red","red")
...
### Figure 3 unweighted unifrac PERMANOVA
```{r f3uu, exercise = T, warning =F, message = F,  exercise.timelimit = 10000, eval = F}
...
fig1_Suw_permanova <- adonis(flies_unweighted_dm ~ genotype * sex + vial_model, flies_unifrac_table, permutations=1000)
fig1_permSU <- tableGrob(round(fig1_Suw_permanova$aov.tab, 2), theme=ttheme_minimal())
plot(fig1_permSU)
```

### print figure S5
```{r FigureS5print, exercise=T, warning = F, message = F, eval = F, exercise.timelimit = 10000}
...
```{r FigureS6, exercise=T, warning = F, message = F, eval = F, exercise.timelimit = 10000 }
...
### Figure S4A
```{r FigureS4, exercise=T, warning = F, message = F, eval = F, exercise.timelimit = 10000}
...
### Figure S4B
```{r FigureS4B, exercise=T, warning = F, message = F, eval = F, exercise.timelimit = 10000}
var1 = "genotype"
var2 = "sex"
var1_colors <-c("black","black","blue","blue","red","red")
var2_shape <- c(15,0,15,0,15,0)
...
### Figure S4 weighted Unifrac PERMANOVA
```{r fs4wu, exercise=T, warning = F, message = F, eval = T, exercise.timelimit = 10000}
## weighted
...
### Figure S4C
```{r FigureS4C, exercise=T, warning = F, message = F, eval = T, exercise.timelimit = 10000}
var1 = "genotype"
var2 = "sex"
var1_colors <-c("black","black","blue","blue","red","red")
var2_shape <- c(15,0,15,0,15,0)
...
### Figure S4 unweighted Unifrac PERMANOVA
```{r fs4uu, exercise=T, warning = F, message = F, eval = T, exercise.timelimit = 10000}
...
### Figure S4D
```{r FigureS4D, exercise=T, warning = F, message = F, eval = F, exercise.timelimit = 10000}
var1 = "genotype"
var2 = "sex"
var1_colors <-c("black","black","blue","blue","red","red")
var2_shape <- c(15,0,15,0,15,0)
...
### Figure S4 Bray Curtis PERMANOVA
```{r fs4bc, exercise=T, warning = F, message = F, eval = T, exercise.timelimit = 10000}
## bray curtis
...
### print Figure S4
```{r PrintFigureS4, exercise=T, warning = F, message = F, eval = T, exercise.timelimit = 10000}
...
```{r PrintFigureS4_PERMANOVA, exercise=T, warning = F, message = F, eval = T, exercise.timelimit = 10000}
...
## Figure 5
### Figure 5A
```{r Figure5A, exercise=T, warning = F, message = F, eval = T, exercise.timelimit = 10000}
...
### Figure 5B
```{r Figure5B, exercise=T, warning = F, message = F, eval = T, exercise.timelimit = 10000}
var1 = "genotype"
var2 = "genotype"
...
### print Figure 5
```{r printFig5, exercise=T, warning = F, message = F, eval = T, exercise.timelimit = 10000}
...
### Figure S7A
```{r FigureS7A, exercise=T, warning = F, message = F, eval = T, exercise.timelimit = 10000}
var1 = "genotype"
var2 = "genotype"
var1_colors <-c("black","black")
var2_shape <- c(15,0)
...
### Figure S7B
```{r FigureS7B, exercise=T, warning = F, message = F, eval = T, exercise.timelimit = 10000}
var1 = "genotype"
var2 = "genotype"
var1_colors <-c("black","black")
var2_shape <- c(15,0)
...
### print Figure S7
```{r printFigS7, exercise = T, eval=FALSE, exercise.timelimit = 10000}
...
```{r FigureS5ancom,exercise=T, warning = F, message = F, eval = T, exercise.timelimit = 10000}
...
## Figure S8
### Figure S8A
```{r FigureS8A, exercise=T, warning = F, message = F, eval = T, exercise.timelimit = 10000}
...
### Figure S8B
```{r FigureS8B, exercise=T, warning = F, message = F, eval = T, exercise.timelimit = 10000}
var1 = "genotype"
var2 = "sample_type"
...
### Figure S8 weighted Unifrac PERMANOVA
```{r fs8wu, exercise=T, warning = F, message = F, eval = T, exercise.timelimit = 10000}
...
### Figure S8C
```{r FigureS8C, exercise=T, warning = F, message = F, eval = T, exercise.timelimit = 10000}
var1 = "genotype"
var2 = "sample_type"
var1_colors <-c("green","green","black","black")
var2_shape <- c(0,15,0,15)
...
### Figure S8 unweighted Unifrac PERMANOVA
```{r fs8uu, exercise=T, warning = F, message = F, eval = T, exercise.timelimit = 10000}
...
### Figure S8D
```{r FigureS8D, exercise=T, warning = F, message = F, eval = T, exercise.timelimit = 10000}
var1 = "genotype"
var2 = "sample_type"
var1_colors <-c("green","green","black","black")
var2_shape <- c(0,15,0,15)
...
### Figure S8 bray curtis PERMANOVA
```{r fs8bc, exercise=T, warning = F, message = F, eval = T, exercise.timelimit = 10000}
...
### print figure S8
```{r print_Figure_S8, exercise=T, warning = F, message = F, eval = T, exercise.timelimit = 10000}
...
```{r print_Figure_S8_PERMANOVA, exercise=T, warning = F, message = F, eval = T, exercise.timelimit = 10000}
getwd()
